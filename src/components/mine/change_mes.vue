  ...
  <div class="change_mes">
    ...
    <div class="mes_con">
      <ul>
        <li>
          <p>
            <el-input type="text" v-model="userMes.engineerVO.name" placeholder="请输入您的姓名"></el-input>
          </p>
        </li>
        <li>
          <p>
            <el-input type="text" v-model="userMes.email" placeholder="请输入您的邮箱"></el-input>
          </p>
        </li>
        <li>
          <p>
            <el-input type="text" v-model="userMes.engineerVO.phone" placeholder="请输入您的手机号"></el-input>
          </p>
        </li>
        <li>
          <p>
            <el-input type="text" v-model="userMes.engineerVO.workYear"  placeholder="请输入您的工作年限"></el-input>
          </p>
